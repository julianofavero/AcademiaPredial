...
<body>
	<header>
		<nav class="navbar navbar-expand-md navbar-dark bg-dark">
			...
			<ul class="navbar-nav">
				<li>
					<a href="<%=request.getContextPath()%>/listagem" 
	...
	<div class="container">
				...
				<a href="<%=request.getContextPath()%>/novo" 
				   class="btn btn-success btn-sm float-right">Adicionar Reserva</a>
			</div>
		</div>
		<br>
				...
				<tbody>
					<c:forEach var="cliente" items="${listarCliente}">
						<tr>
							...
							<td>
								<a href="editar?codigo=<c:out value='${cliente.codigo}' />" 
								    class="btn btn-primary btn-sm">Editar</a>
								<a href="deletar?codigo=<c:out value='${cliente.codigo}' />" 
